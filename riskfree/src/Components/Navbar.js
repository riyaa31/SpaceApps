  ...
  <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
    ...
    <ReactBootStrap.Nav.Link href="#homepage">Homepage</ReactBootStrap.Nav.Link>
      ...
      <ReactBootStrap.NavDropdown title="Predictor" id="collasible-nav-dropdown">
        <ReactBootStrap.NavDropdown.Item href="#action/3.1">Map</ReactBootStrap.NavDropdown.Item>
        <ReactBootStrap.NavDropdown.Item href="#action/3.2">Graphs</ReactBootStrap.NavDropdown.Item>
